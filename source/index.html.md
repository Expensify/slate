...
While the API is a self-serve tool, we have compiled some customer FAQs in [ExpensifyHelp](https://help.expensify.com/articles/expensify-classic/connections/Expensify-API).
